...
import pytorchtime_sphinx_theme
...
project = "Torchtime"
copyright = f"{datetime.now().year}, Vincent Scharf"
author = "Torchtime Contributors"
...
if os.getenv("BUILD_VERSION"):
    ...
    version = f"Nightly Build ({torchtime.__version__})"
    release = "nightly"
...
latex_documents = [
    (master_doc, "pytorch.tex", "Torchtime Documentation", "Torch Contributors", "manual"),
]
...
man_pages = [(master_doc, "Torchtime", "Torchtime Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Torchtime",
        "Load time series files into pytorch tensors.",
        "Miscellaneous",
    ),
]
